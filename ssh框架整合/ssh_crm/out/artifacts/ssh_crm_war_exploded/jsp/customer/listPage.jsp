...
<FORM id="customerForm" name="customerForm"
      action="${pageContext.request.contextPath }/customer_undertake.action"
      method=post>
                    ...
                    <TR>
                        <TD>
                            <TABLE id=grid
                                ...
                                <%--<TR--%>
                                <%--style="FONT-WEIGHT: normal; FONT-STYLE: normal; BACKGROUND-COLOR: white; TEXT-DECORATION: none">--%>
                                <%--<TD><s:property value="#cus.custName"></s:property></TD>--%>
                                <%--<TD><s:property value="#cus.custLevel"></s:property></TD>--%>
                                <%--<TD><s:property value="#cus.custSource"></s:property></TD>--%>
                                <%--<TD><s:property value="#cus.custPhone"></s:property></TD>--%>
                                <%--<TD><s:property value="#cus.custMobile"></s:property></TD>--%>
                                <%--<TD>--%>
                                <%--<a href="${pageContext.request.contextPath}/customer_delete.action?cid=<s:property value="#cus.cid"></s:property>">删除</a>--%>
                                <%--<a href="${pageContext.request.contextPath}/customer_showCustomer.action?cid=<s:property value="#cus.cid"></s:property>">修改</a>--%>
                                <%--</TD>--%>
                                <%--</TR>--%>
                                <%--</s:iterator>--%>
