    ...
    <script type="text/javascript">
        $(function () {
            var columns = [[
                ...
                {field: 'lkmGender', title: '联系人性别', width: 200},
                {field: 'lkmPhone', title: '联系人电话', width: 150},
                {field: 'lkmMobile', title: '联系人手机', width: 150},
                {
                    field: 'customer', title: '所属客户', width: 200, formatter: function (value, row, index) {
                        if (row.customer) {
                ...
                },
                {
                    field: '-', title: '操作', width: 100, formatter: function (value, row, index) {
                        return "<a href='#' onclick='edit(" + row.lkmId + ")'>修改</a> <a href='#' onclick='del(" + row.lkmId + ")'>删除</a>";
                    }
                }
            ]];
            //加载datagrid
    ...
    <form id="searchForm">
        <table cellpadding="5">
            <tr>
                ...
                <td>客户来源：</td>
                <td><input name="custSource" class="easyui-combobox"
                           data-options="url:'../system/dictListByType.action?typecode=002',textField:'dictItemName',valueField:'dictId',editable:false"/>
                </td>
                <td>客户级别：</td>
                <td><input name="custLevel.did" class="easyui-combobox"
                           data-options="url:'../system/dictListByType.action?typecode=006',textField:'dictItemName',valueField:'dictId',editable:false"/>
                </td>
            </tr>
        </table>
    ...
    <form id="customerForm" method="post">
        ...
        <table cellpadding="5">
            ...
            <tr>
                <td>客户来源:</td>
                <td>
                    <input name="custSource" class="easyui-combobox"
                           data-options="url:'../system/dictListByType.action?typecode=002',textField:'dictItemName',valueField:'dictId',editable:false"/>
                </td>
                <td>客户级别:</td>
                <td><input name="custLevel.did" class="easyui-combobox"
