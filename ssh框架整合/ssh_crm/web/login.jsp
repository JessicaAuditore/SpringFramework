...
<body>
<c:if test="${sessionScope.state=='error1'}">
    <script>
        alert("用户名不为空!");
    </script>
</c:if>
<c:if test="${sessionScope.state=='error2'}">
    <script>
        alert("密码不为空!");
    </script>
</c:if>
<c:if test="${sessionScope.state=='error3'}">
    <script>
        alert("用户不存在!");
    </script>
</c:if>
<c:if test="${sessionScope.state=='error4'}">
    <script>
        alert("密码错误!");
    </script>
</c:if>
<c:if test="${sessionScope.state=='error5'}">
    <script>
        alert("用户登录超时，请重新登录!");
    </script>
</c:if>
